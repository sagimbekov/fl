function querLoaderComplete() {
    ...
    var e = new Array,
        ...
        o = {
            ...
            r = $("<div></div>").appendTo("body").css({
                display: "none",
                width: 0,
                height: 0,
                overflow: "hidden"
            });
            for (var t = 0; e.length > t; t++) $.ajax({
                url: e[t],
                type: "HEAD",
                success: function (e) {
                    n++;
            ...
            var t = $("<img />").attr("src", e).bind("load", function () {
                l(function () {})
            }).appendTo(r)
        }, l = function () {
            t++;
            var e = t / n * 100,
                r = Math.ceil(e);
            progress_arc_anim = Raphael.animation({
                arc: [pieXYLoc, pieXYLoc, r, pieStrokeMaxVal, pieRadius]
            }, 100, "easeInOut");
            progress_arc.animate(progress_arc_anim);
            o.percentage == 1 && $(i).text(Math.ceil(e) + "%");
            t == n && c()
        }, c = function () {
            $(r).remove();
            o.onLoadComplete()
        }, h = function () {
            o.percentage == 1 && (i = $(o.qLtarget).text("0%"))
        }, p = function (t) {
            var n = "";
            if ($(t).css("background-image") != "none") var n = $(t).css("background-image");
            else if (typeof $(t).attr("src") != "undefined" && t.nodeName.toLowerCase() == "img") var n = $(t).attr("src");
            if (n.indexOf("gradient") == -1) {
                ...
                for (var i = 0; i < r.length; i++)
                    if (r[i].length > 0) {
                        var s = "";
                        s = "?" + Math.floor(Math.random() * 3e3);
                        e.push(r[i] + s)
                    }
            }
        };
    $.fn.queryLoader2 = function (e) {
        e && $.extend(o, e);
        this.each(function () {
            p(this);
            o.deepSearch == 1 && $(this).find("*:not(script)").each(function () {
                p(this)
            })
        });
        u();
...
(function (e) {
    e.fn.instagram = function (t) {
        function s(t) {
            var n = t.images.thumbnail.url;
            i.image_size == "low_resolution" ? n = t.images.low_resolution.url : i.image_size == "thumbnail" ? n = t.images.thumbnail.url : i.image_size == "standard_resolution" && (n = t.images.standard_resolution.url);
            var r = e("<img>").addClass("thumb-img").attr("src", n);
            i.photoLink && (r = e("<a>").addClass("thumb").attr("target", "_blank").attr("href", t.link).append(r));
            return e("<article>").addClass("instagram-article").attr("id", t.id).append(r)
        }

        function o() {
            return e("<div>").addClass("instagram-placeholder").attr("id", "empty").append(e("<p>").html("No photos for this query"))
        }

        function u() {
            var t = r,
                n = {};
            if (i.next_url != null) return i.next_url;
            if (i.hash != null) t += "/tags/" + i.hash + "/media/recent";
            ...
            } else i.userId != null ? t += "/users/" + i.userId + "/media/recent" : i.locationId != null ? t += "/locations/" + i.locationId + "/media/recent" : t += "/media/popular";
            i.accessToken != null && (n.access_token = i.accessToken);
            i.clientId != null && (n.client_id = i.clientId);
            i.minId != null && (n.min_id = i.minId);
            i.maxId != null && (n.max_id = i.maxId);
            i.show != null && (n.count = i.show);
            t += "?" + e.param(n);
            return t
        }
        var n = this,
        ...
        e.ajax({
            ...
            url: u(),
            success: function (e) {
                var t = typeof e.data != "undefined" ? e.data.length : 0,
                    r = i.show != null && i.show < t ? i.show : t;
                if (r > 0)
                    for (var u = 0; u < r; u++) n.append(s(e.data[u]));
                else n.append(o());
                i.onComplete != null && typeof i.onComplete == "function" && i.onComplete(e.data, e)
            }
        });
        return this
    }
...
(function (e) {
    ...
    l.off = l.unbind = function (e, t) {
        ...
        for (l = 0, c = s.length; l < c; l++)
            for (h = 0; h < d.length; h += a.length - 2) {
                a = [h, 1];
                o = d[h].n;
...
(function () {
    ...
    function _t(t, n, r) {
        ...
        for (d = 0; d < f + 1; d++) {
            v = e.findDotsAtSegment.apply(e, n.concat(d / f));
            c.push({
                x: v.x,
                y: v.y,
                t: d / f
    ...
    function gn() {
        return this.x + m + this.y + m + this.width + " Г— " + this.height
    }
    ...
    function Mn(t, r, i, s, u, a) {
        ...
        if (!l) {
                    ...
                    if (V[o](C) || r.paper.customAttributes[o](C)) {
                        ...
                        case "transform":
                            ...
                            if (P) {
                                ...
                                w[C] = [H.a, H.b, H.c, H.d, H.e, H.f];
                                Yt(B, E[C]);
                                E[C] = B._.transform;
                                S[C] = [(B.matrix.a - H.a) / b, (B.matrix.b - H.b) / b, (B.matrix.c - H.c) / b, (B.matrix.d - H.d) / b, (B.matrix.e - H.e) / b, (B.matrix.f - H.f) / b]
                            }
                            break;
                        case "csv":
                            var j = g(f[C])[y](n),
                        ...
                        default:
                            ...
                            F = [][p](w[C]);
                            S[C] = [];
                            T = r.paper.customAttributes[C].length;
            ...
            if (s && !l && !c) {
                x.stop = !0;
                x.start = new Date - b * s;
                if (Nn.length == 1) return kn()
            }
            c && (x.start = new Date - x.ms * s);
            Nn.length == 1 && Cn(kn)
        } else {
            l.initstatus = s;
    ...
    if (e.type == "VML") {
        var lt = u.doc.createElement("div"),
            ct;
        lt.innerHTML = '<v:shape adj="1"/>';
        ct = lt.firstChild;
        ct.style.behavior = "url(#default#VML)";
    ...
    e.is = function (e, t) {
        t = E.call(t);
        return t == "finite" ? !F[o](+e) : t == "array" ? e instanceof Array : t == "null" && e === null || t == typeof e && e !== null || t == "object" && e === Object(e) || t == "array" && Array.isArray && Array.isArray(e) || D.call(e).slice(8, -1).toLowerCase() == t
    };
    ...
    e.setWindow = function (t) {
        eve("raphael.setWindow", e, u.win, t);
        u.win = t;
    ...
    var dt = function (t) {
        if (e.vml) {
            ...
            a.title = "RaphaГ«l Colour Picker";
    ...
    e.getRGB = Et(function (t) {
        ...
        if (l) {
            ...
            if (l[5]) {
                ...
                s = U(f[2]);
                f[2].slice(-1) == "%" && (s *= 2.55);
                (f[0].slice(-3) == "deg" || f[0].slice(-1) == "В°") && (r /= 360);
    ...
    e.parsePathString = function (t) {
        ...
        e.is(t, O) && e.is(t[0], O) && (i = Ht(t));
        i.length || g(t).replace(G, function (e, t, n) {
            var s = [],
                o = t.toLowerCase();
    ...
    e.parseTransformString = Et(function (t) {
        ...
        e.is(t, O) && e.is(t[0], O) && (r = Ht(t));
        r.length || g(t).replace(Y, function (e, t, n) {
            var i = [],
                s = E.call(t);
            n.replace(Z, function (e, t) {
                t && i.push(+t)
    ...
    e._removedFactory = function (e) {
        return function () {
            eve("raphael.log", null, "RaphaГ«l: you are calling to method вЂњ" + e + "вЂќ of removed object", e)
        }
    };
    var Pt = e.pathBBox = function (e) {
        ...
        for (var u = 0, a = e.length; u < a; u++) {
            ...
            if (o[0] == "M") {
                ...
                i = i[p](f.min.x, f.max.x);
                s = s[p](f.min.y, f.max.y);
                n = o[5];
                r = o[6]
            }
        }
        ...
        return m
            ...
            if (N(_) > l) {
                ...
                u = L + n * S.cos(M);
                a = A + r * S.sin(M);
                h = qt(u, a, n, r, i, 0, o, P, H, [M, D, L, A])
            }
            _ = M - O;
            var B = S.cos(O),
                j = S.sin(O),
            ...
            N(p) > "1e12" && (p = .5);
            if (c > 0 && c < 1) {
                m = Rt(e, t, n, r, i, s, o, u, c);
                v.push(m.x);
                d.push(m.y)
            }
            if (p > 0 && p < 1) {
                m = Rt(e, t, n, r, i, s, o, u, p);
                v.push(m.x);
                d.push(m.y)
            }
            a = s - 2 * r + t - (u - 2 * s + r);
            ...
            var r = jt(e),
                ...
                s = {
                    ...
                    case "T":
                        ...
                        e = ["C"][p](It(t.x, t.y, t.qx, t.qy, e[1], e[2]));
                        break;
                    case "Q":
                        t.qx = e[1];
                        t.qy = e[2];
                        e = ["C"][p](It(t.x, t.y, e[1], e[2], e[3], e[4]));
                        break;
                    case "L":
                    ...
                    if (m == "t" && d == 3)
                        ...
                        if (d == 2) {
                            ...
                            if (y) {
                                ...
                                x = b.y(p[2], p[3]);
                                l.rotate(p[1], S, x)
                            } else l.rotate(p[1], p[2], p[3]);
                            i += p[1]
                        }
                    } else if (m == "s") {
                        if (d == 2 || d == 3) {
                            T = T || t.getBBox(1);
                            l.scale(p[1], p[d - 1], T.x + T.width / 2, T.y + T.height / 2);
                            u *= p[1];
                            a *= p[d - 1]
                        } else if (d == 5) {
                            if (y) {
                                ...
                                x = b.y(p[3], p[4]);
                                l.scale(p[1], p[2], S, x)
                            } else l.scale(p[1], p[2], p[3], p[4]);
                            u *= p[1];
                            a *= p[2]
                        }
                    } else m == "m" && d == 7 && l.add(p[1], p[2], p[3], p[4], p[5], p[6]);
                    f.dirtyT = 1;
                    t.matrix = l
                }
            t.matrix = l;
    ...
    (function (t) {
        ...
        t.split = function () {
            ...
            if (o < 0) {
                ...
                s < 0 && (t.rotate = 360 - t.rotate)
            } else t.rotate = e.deg(S.asin(s));
        ...
        t.toTransformString = function (e) {
            ...
            if (t.isSimple) {
                ...
                return (t.dx || t.dy ? "t" + [t.dx, t.dy] : v) + (t.scalex != 1 || t.scaley != 1 ? "s" + [t.scalex, t.scaley, 0, 0] : v) + (t.rotate ? "r" + [t.rotate, 0, 0] : v)
            }
    ...
    var rn = function () {
            ...
            if (u.doc.attachEvent) return function (e, t, n, r) {
                var i = function (e) {
                    ...
                    var t = u.doc.documentElement.scrollTop || u.doc.body.scrollTop,
                        ...
                        s = e.clientX + i,
                        o = e.clientY + t;
                    e.preventDefault = e.preventDefault || rn;
                    e.stopPropagation = e.stopPropagation || on;
        ...
        ln = function (e) {
            ...
            while (o--) {
                ...
                c && eve("raphael.drag.over." + s.el.id, s.el, c);
                t += i;
                n += r;
                eve("raphael.drag.move." + s.el.id, s.move_scope || s.el, t - s.el._drag.x, n - s.el._drag.y, t, n, e)
            }
        }, cn = function (t) {
            ...
            while (n--) {
                r = fn[n];
                r.el._drag = {};
                eve("raphael.drag.end." + r.el.id, r.end_scope || r.start_scope || r.move_scope || r.el, t)
            }
            fn = []
        }, hn = e.el = {};
    ...
    hn.data = function (t, n) {
        ...
        if (arguments.length == 1) {
            ...
            eve("raphael.data.get." + this.id, this, r[t], t);
            return r[t]
        }
        r[t] = n;
        eve("raphael.data.set." + this.id, this, n, t);
        return this
    };
    hn.removeData = function (e) {
        e == null ? tt[this.id] = {} : tt[this.id] && delete tt[this.id][e];
        return this
    };
    ...
    hn.drag = function (t, n, r, i, s, o) {
        function a(a) {
            ...
            !fn.length && e.mousemove(ln).mouseup(cn);
            fn.push({
                el: this,
                move_scope: i,
                start_scope: s,
            ...
            n && eve.on("raphael.drag.start." + this.id, n);
            t && eve.on("raphael.drag.move." + this.id, t);
            r && eve.on("raphael.drag.end." + this.id, r);
            eve("raphael.drag.start." + this.id, s || i || this, a.clientX + l, a.clientY + f, a)
        }
        this._drag = {};
        dn.push({
            el: this,
    ...
    hn.undrag = function () {
        ...
        while (t--)
            if (dn[t].el == this) {
                this.unmousedown(dn[t].start);
                dn.splice(t, 1);
                eve.unbind("raphael.drag.*." + this.id)
            }!dn.length && e.unmousemove(ln).unmouseup(cn)
    };
    ...
    hn.getBBox = function (e) {
        ...
        if (e) {
            if (t.dirty || !t.bboxwt) {
                this.realPath = at[this.type](this);
                t.bboxwt = Pt(this.realPath);
                t.bboxwt.toString = gn;
                t.dirty = 0
            }
            return t.bboxwt
        }
        if (t.dirty || t.dirtyT || !t.bbox) {
            ...
            t.bbox = Pt(ft(this.realPath, this.matrix));
            t.bbox.toString = gn;
            t.dirty = t.dirtyT = 0
        }
        return t.bbox
    ...
    Tn.easeIn = Tn["ease-in"] = Tn["<"];
    Tn.easeOut = Tn["ease-out"] = Tn[">"];
    Tn.easeInOut = Tn["ease-in-out"] = Tn["<>"];
    Tn["back-in"] = Tn.backIn;
    Tn["back-out"] = Tn.backOut;
    var Nn = [],
        Cn = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (e) {
            ...
            for (; n < Nn.length; n++) {
                ...
                if (r.initstatus) {
                    ...
                    delete r.initstatus;
                    r.stop && Nn.splice(n--, 1)
                } else r.status = (r.prev + (r.percent - r.prev) * (i / s)) / r.anim.top; if (i < 0) continue;
                if (i < s) {
                    var b = u(i / s);
                    for (var w in a)
                        if (a[o](w)) {
                            ...
                            default:
                                var C = [][p](a[w]);
                                v = [];
                                E = h.paper.customAttributes[w].length;
                    ...
                    (function (t, n, r) {
                        setTimeout(function () {
                            eve("raphael.anim.frame." + n.id, n, r);
                            eve("raphael.anim.finish." + n.id, n, r);
                    ...
                    if (r.repeat > 1 && !r.next) {
                        ...
                        r.el.attr(g);
                        Mn(r.anim, r.el, r.anim.percents[0], null, r.totalOrigin, r.repeat - 1)
                    }
    ...
    hn.animate = function (t, n, r, i) {
        ...
        Mn(o, s, o.percents[0], null, s.attr());
        return s
    };
    hn.setTime = function (e, t) {
        e && t != null && this.status(e, T(t, e.ms) / e.ms);
        return this
    };
    ...
    hn.resume = function (e) {
        for (var t = 0; t < Nn.length; t++)
            if (Nn[t].el.id == this.id && (!e || Nn[t].anim == e)) {
                var n = Nn[t];
                if (eve("raphael.anim.resume." + this.id, this, n.anim) !== !1) {
                    delete n.paused;
    ...
    eve.on("raphael.remove", _n);
    eve.on("raphael.clear", _n);
    hn.toString = function () {
        return "RaphaГ«lвЂ™s object"
    };
    var Dn = function (e) {
        this.items = [];
        this.length = 0;
        ...
        if (e)
            for (var t = 0, n = e.length; t < n; t++)
                if (e[t] && (e[t].constructor == hn.constructor || e[t].constructor == Dn)) {
    ...
    Pn.push = function () {
        ...
        for (var n = 0, r = arguments.length; n < r; n++) {
            e = arguments[n];
            if (e && (e.constructor == hn.constructor || e.constructor == Dn)) {
                t = this.items.length;
        ...
        if (s) {
            ...
            for (var S = 0, N = f.length; S < N; S++) {
                if (f[S] == "\n") {
                    ...
                    l += c ? (C.w || s.w) + (C.k && C.k[f[S]] || 0) + s.w * a : 0;
                    c = 1
                }
    ...
    l.add = function (t) {
        if (e.is(t, "array")) {
            ...
            for (; i < s; i++) {
                u = t[i] || {};
                r[o](u.type) && n.push(this[u.type]().attr(u))
            }
        }
        return n
    };
...
window.Raphael.svg && function (e) {
            ...
            if (r.type == "path") {
                ...
                if (g != "none") {
                    ...
                    if (s) {
                        ...
                        b = e.getTotalLength(l.path) - O * h
                    } else {
                        y = O * h;
                        b = e.getTotalLength(l.path) - (r._.arrows.enddx * h || 0)
                    }
                    S = {};
                    S["marker-" + a] = "url(#" + k + ")";
                ...
                if (s[t](d)) {
                    ...
                    case "path":
                        if (r.type == "path") {
                            ...
                            r._.dirty = 1;
                            if (r._.arrows) {
                                "startString" in r._.arrows && b(r, r._.arrows.startString);
                    ...
                    case "fill-opacity":
                        if (l.gradient) {
                            _ = e._g.doc.getElementById(a.getAttribute("fill").replace(/^url\(#|\)$/g, c));
                            if (_) {
    ...
    C.attr = function (n, r) {
        ...
        if (r == null && e.is(n, "string")) {
            ...
            for (var a = 0, c = o.length; a < c; a++) {
                n = o[a];
                n in this.attrs ? u[n] = this.attrs[n] : e.is(this.paper.customAttributes[n], "function") ? u[n] = this.paper.customAttributes[n].def : u[n] = e._availableAttrs[n]
            }
            return c - 1 ? u : u[o[0]]
        }
    ...
    C.toBack = function () {
        ...
        t.tagName.toLowerCase() == "a" ? t.parentNode.insertBefore(this.node.parentNode, this.node.parentNode.parentNode.firstChild) : t.firstChild != this.node && t.insertBefore(this.node, this.node.parentNode.firstChild);
    ...
    C.insertAfter = function (t) {
        ...
        n.nextSibling ? n.parentNode.insertBefore(this.node, n.nextSibling) : n.parentNode.appendChild(this.node);
    ...
    e._engine.create = function () {
        ...
        if (n == 1) {
            ...
            n.firstChild ? n.insertBefore(u, n.firstChild) : n.appendChild(u)
        }
        n = new e._Paper;
        n.width = s;
        n.height = o;
    ...
    e.prototype.clear = function () {
        ...
        (this.desc = m("desc")).appendChild(e._g.doc.createTextNode("Created with RaphaГ«l " + e.version));
...
window.Raphael.vml && function (e) {
    var t = "hasOwnProperty",
        ...
        E = {
            ...
            if (l || o.fillsize) {
                ...
                o.fillsize && (E.size = o.fillsize[0] * a(t) + p + o.fillsize[1] * a(n));
                c.appendChild(E)
            }
            h.visibility = "visible"
        };
    e.toString = function () {
        return "Your browser doesnвЂ™t support SVG. Falling down to VML.\nYou are running RaphaГ«l " + this.version
    };
    var C = function (e, t, r) {
        ...
        l[s + "arrowwidth"] = f
            ...
            if ("clip-rect" in a) {
                ...
                if (D.length == 4) {
                    ...
                    var P = c.clipRect || e._g.doc.createElement("div"),
                        H = P.style;
                    H.clip = e.format("rect({1}px {2}px {3}px {0}px)", D);
                    if (!c.clipRect) {
                        H.position = "absolute";
                        H.top = 0;
                        H.left = 0;
            ...
            if (i.textpath) {
                ...
                a["font-family"] && (B.fontFamily = '"' + a["font-family"].split(",")[0].replace(/^['"]+|['"]+$/g, d) + '"');
            ...
            if (a.opacity != null || a["stroke-width"] != null || a.fill != null || a.src != null || a.stroke != null || a["stroke-width"] != null || a["stroke-opacity"] != null || a["fill-opacity"] != null || a["stroke-dasharray"] != null || a["stroke-miterlimit"] != null || a["stroke-linejoin"] != null || a["stroke-linecap"] != null) {
                ...
                if (j.on && a.fill) {
                    ...
                    if (I) {
                        ...
                        j.color = e.getRGB(a.fill).hex;
                        j.src = d;
                        j.type = "solid";
                        if (e.getRGB(a.fill).error && (b.type in {
                            circle: 1,
                            ellipse: 1
                        } || n(a.fill).charAt() != "r") && L(b, a.fill, j)) {
                            h.fill = "none";
                            h.gradient = a.fill;
                            j.rotate = !1
                        }
                ...
                z.on && a.stroke && (z.color = X.hex);
                U = ((+h["stroke-opacity"] + 1 || 2) - 1) * ((+h.opacity + 1 || 2) - 1) * ((+X.o + 1 || 2) - 1);
                var V = (r(a["stroke-width"]) || 1) * .75;
                U = u(o(U, 0), 1);
                a["stroke-width"] == null && (V = h["stroke-width"]);
                a["stroke-width"] && (z.weight = V);
                V && V < 1 && (U *= V) && (z.weight = 1);
                z.opacity = U;
                a["stroke-linejoin"] && (z.joinstyle = a["stroke-linejoin"] || "miter");
                z.miterlimit = a["stroke-miterlimit"] || 8;
                a["stroke-linecap"] && (z.endcap = a["stroke-linecap"] == "butt" ? "flat" : a["stroke-linecap"] == "square" ? "square" : "round");
            ...
            if (b.type == "text") {
                ...
                Q = r(h["font-size"] || Q && Q[0]) || 10;
                v.fontSize = Q * K + "px";
                b.textpath.string && (J.innerHTML = n(b.textpath.string).replace(/</g, "&#60;").replace(/&/g, "&#38;").replace(/\n/g, "<br>"));
                var G = J.getBoundingClientRect();
                b.W = h.w = (G.right - G.left) / K;
                b.H = h.h = (G.bottom - G.top) / K;
                b.X = h.x;
                b.Y = h.y + b.H / 2;
            ...
            s = n(s).replace(e._radial_gradient, function (e, t, n) {
                ...
                if (t && n) {
                    t = r(t);
                    n = r(n);
                    a(t - .5, 2) + a(n - .5, 2) > .25 && (n = i.sqrt(.25 - a(t - .5, 2)) * ((n > .5) * 2 - 1) + .5);
                    h = t + p + n
                }
                return d
            });
    ...
    O.transform = function (t) {
        ...
        var r = this.paper._viewBoxShift,
            ...
            s;
        r && (s = t = n(t).replace(/\.{3}|\u2026/g, this._.transform || d));
    ...
    O.insertAfter = function (t) {
        if (this.removed) return this;
        t.constructor == e.st.constructor && (t = t[t.length - 1]);
    ...
    e._engine.create = function () {
        ...
        if (n == 1) {
            ...
            l.top = u + "px";
            l.position = "absolute"
        } else n.firstChild ? n.insertBefore(f, n.firstChild) : n.appendChild(f);
...
(function (e, t) {
    ...
    respond.mediaQueriesSupported = t;
    if (t) return;
    var n = e.document,
        r = n.documentElement,
        i = [],
        ...
        h = function () {
            var t = l,
                ...
                i, s, o, a;
            for (; r < n; r++) {
                i = t[r], s = i.href, o = i.media, a = i.rel && i.rel.toLowerCase() === "stylesheet";
                if ( !! s && a && !u[s])
                    if (i.styleSheet && i.styleSheet.rawCssText) {
                        d(i.styleSheet.rawCssText, s, o);
                        u[s] = !0
                    } else(!/^([a-zA-Z]+?:(\/\/)?)/.test(s) || s.replace(RegExp.$1, "").split("/")[0] === e.location.host) && c.push({
                        href: s,
                        media: o
                    })
            }
            ...
            for (; f < o; f++) {
                ...
                if (a) {
                    ...
                    c = r[f].match(/@media ([^\{]+)\{([\S\s]+?)$/) && RegExp.$1;
            ...
            var t = "clientWidth",
                u = r[t],
                c = n.compatMode === "CSS1Compat" && u || n.body[t] || u,
                h = {}, p = n.createDocumentFragment(),
                d = l[l.length - 1],
                y = (new Date).getTime();
            if (e && v && y - v < a) {
                clearTimeout(m);
            ...
            for (var b in i) {
                var w = i[b];
                if (!w.minw && !w.maxw || (!w.minw || w.minw && c >= w.minw) && (!w.maxw || w.maxw && c <= w.maxw)) {
                    h[w.media] || (h[w.media] = []);
                    h[w.media].push(s[w.rules])
                }
            }
            for (var b in o) o[b] && o[b].parentNode === f && f.removeChild(o[b]);
            for (var b in h) {
                var E = n.createElement("style"),
                    S = h[b].join("\n");
                E.type = "text/css";
                E.media = b;
                E.styleSheet ? E.styleSheet.cssText = S : E.appendChild(n.createTextNode(S));
                p.appendChild(E);
                o.push(E)
            }
            f.insertBefore(p, d.nextSibling)
        }, y = function (e, t) {
            var n = b();
            if (!n) return;
            n.open("GET", e, !0);
    ...
    h();
    respond.update = h;
    e.addEventListener ? e.addEventListener("resize", w, !1) : e.attachEvent && e.attachEvent("onresize", w)
})(this, function (e) {
    ...
    var t, n = document,
        ...
        a = "only all";
    u.id = "mq-test-1";
    u.style.cssText = "position:absolute;top:-99em";
    o.appendChild(u);
    u.innerHTML = '_<style media="' + a + '"> #mq-test-1 { width: 9px; }</style>';
    s && r.insertBefore(o, i);
    u.removeChild(u.firstChild);
    t = u.offsetWidth == 9;
    s ? r.removeChild(o) : o.removeChild(u);
    return t
}(this));
typeof _gaq != "undefined" && _gaq !== null && $(document).ajaxSend(function (e, t, n) {
