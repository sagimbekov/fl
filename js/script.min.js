        ...
        function e(e) {
            ...
            if (e === "user_experience") {
                var i = t.path().attr({
                    ...
                    s = Raphael.animation({
                        arc: [pieXYLoc, pieXYLoc, 35, pieStrokeMaxVal, pieRadius]
                    }, animTime * 4 * .3, "easeInOut");
            ...
            if (e === "visual_design") {
                var o = t.path().attr({
                    ...
                    u = Raphael.animation({
                        arc: [pieXYLoc, pieXYLoc, 90, pieStrokeMaxVal, pieRadius]
            ...
            if (e === "development") {
                var a = t.path().attr({
                    ...
                    f = Raphael.animation({
                        arc: [pieXYLoc, pieXYLoc, 25, pieStrokeMaxVal, pieRadius]
                    }, animTime * 4 * .3, "easeInOut");
            ...
            if (e === "responsive_design") {
                var l = t.path().attr({
                    ...
                    c = Raphael.animation({
                        arc: [pieXYLoc, pieXYLoc, 75, pieStrokeMaxVal, pieRadius]
                    }, animTime * 4 * .7, "easeInOut");
